  ...
  <div class="app-container calendar-list-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="是否系统数据" prop="sys">
          <el-radio
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sys: [{ required: true, message: '是否系统必选', trigger: 'blur' }],
  ...
  methods: {
    ...
    getRoleMenus(roleId, menuModule) {
      getRoleMenuId(roleId).then(response => {
        this.selectMenuIds = response.data
      })
    },
    ...
    async toSetMenu(row) {
      ...
      if (!this.menuData) {
        const response = await getVueTreeMenu()
